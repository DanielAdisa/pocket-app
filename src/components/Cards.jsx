  ...
  return (
    <div className=" md:pl-11 md:pr-11 md:max-w-[1034px] mx-auto md:mx-auto mb-48 p-4">
        ...
        <div className="grid items-center content-center justify-center grid-cols-1 gap-4 mx-auto md:gap-8 md:grid-cols-5">
            ...
            <div className="md:col-span-3 col-span-1 max-h-[600px] bg-[#f0eff2] rounded-[36px] p-10 ">
                <div className="grid grid-rows-2 gap-4">
                    <div className="row-span-1 ">
                      <p className="">Connect your physical card to your personal Pocket, Groups, and Shops. You're in complete control.</p>
                    </div>
                    <div className="relative flex row-span-1 ">
                      <img src={card} alt=" " className="-mt-32 md:-mt-52 " />
                    </div>
                </div>
            </div>
