    ...
    <section className="w-full mx-auto md:w-[1200px] mt-[50px] pb-[20px] h-fit md:max-w-[1200px]">
       <div className="flex items-start justify-between w-full pl-[71.8px] pt-[71.8px] h-full greengrid2 overflow-clip">
            <div className="w-1/3">
                ...
                <p className="text-[1em] uppercase font-grey-med tracking-[2px] text-black/90">Payments</p>
                ...
                <p className="text-[19px] flex font-grey-med text-white/90 items-center gap-3 text-start mt-[100px] w-[35%] leading-[26px]">Get Spot  <IoArrowForwardCircleOutline /> </p>
            </div>
