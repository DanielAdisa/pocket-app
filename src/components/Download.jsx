...
const Download = () => {
  return (
    <div className=" md:pl-11 md:pr-11 md:w-screen md:max-w-[100vw]  mx-auto md:mx-auto pr-4 pl-4 md:mb-6 ">
        <div className="w-full wavy md:h-screen md:max-h-[50vh] max-h-[90vh] rounded-[2.5em]  h-screen mx-auto md:w-full p-4 justify-center md:max-w-[80vw] md:p-10 md:pb-0 mb-10 ">
            <div className="grid w-full h-full md:max-h-[100%]  col-span-1 row-span-2 gap-x-6 md:grid-rows-4 md:grid-cols-6 ">
                <div className="flex-col w-full md:max-h-[100%] h-full text-center content-start rounded-3xl md:col-span-3 md:row-span-4">
                    <RiMobileDownloadLine  className="mx-auto text-6xl md:text-8xl "/>
                    <p className="text-3xl md:text-[2.75em]   text-white">Download LitePay App</p>
                    <p className="text-xl md:text-[1.7em] md:max-w-[70%] mx-auto text-white">Over 2 million people trust LitePay for their daily money moves, download LitePay today to get started.</p>
                ...
                <div className="w-full h-full rounded-3xl md:col-span-3 md:row-span-4">
                  <div className="flex-col content-end mx-auto pb-0 w-[60%] h-full ">
                      <img src={phone} alt="" />
                  </div>
                </div>
            </div>
