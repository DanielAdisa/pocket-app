        ...
        <div className="w-full wavy md:h-screen md:max-h-[90vh] max-h-[90vh] rounded-[2.5em]  h-screen mx-auto md:w-full p-4 justify-center md:max-w-[80vw] md:p-10 md:pb-0 mb-10 ">
            <div className="grid w-full h-full col-span-1 row-span-2 gap-x-6 md:grid-rows-4 md:grid-cols-6 ">
                <div className="flex-col w-full h-full text-center rounded-3xl md:col-span-3 md:row-span-4">
                    <RiMobileDownloadLine  className="mx-auto mb-4 text-6xl md:text-8xl "/>
                    <p className="text-3xl md:text-[2.75em] text-white">Download LitePay App</p>
                    <p className="text-xl md:text-[1.4em] text-white">Over 2 million people trust LitePay for their daily money moves, download LitePay today to get started.</p>
                </div>
                <div className="w-full h-full bg-black rounded-3xl md:col-span-3 md:row-span-4"></div>
            </div>
        </div>
