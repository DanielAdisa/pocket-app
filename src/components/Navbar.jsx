...
const Navbar = () => {
  return (
    <nav className="py-4 mx-auto shadow-2xl shadow-white">
        <div className="flex items-center justify-between">
        <div className="flex ml-4">
            <p className="pt-2 pb-2 pl-4 pr-4 text-[#034b93] hover:bg-blue-600 hover:text-stone-300 rounded-full "><GiPayMoney className="text-3xl " /></p>
        </div>
