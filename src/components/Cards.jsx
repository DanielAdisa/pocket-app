  ...
  return (
    <div className=" md:pl-11 md:pr-11 md:max-w-[1034px] mx-auto md:mx-auto mb-48 p-4">
        ...
        <div className="grid items-center content-center justify-center grid-cols-1 gap-4 mx-auto md:gap-8 md:grid-cols-5">
            ...
            <div className="md:col-span-3 col-span-1 max-h-fit md:max-h-[600px] bg-[#f0eff2] rounded-[36px] pb-0 p-10 ">
                <div className="grid grid-rows-2 gap-4">
                    ...
                    <div className="relative flex w-full row-span-1 pb-0 mb-0">
                      <img src={card} alt=" " className="pb-0 mx-auto mb-0 md:-mt-52" />
                    </div>
                </div>
            </div>
            ...
            {/* Orange */}
            <div className="md:col-span-2  col-span-1 min-h-[600px] bg-[#f9a70b] rounded-[36px]">
              ...
              <p className="text-center">Spend globally with virtual cards</p>
            </div>
        </div>
    </div>
  )
