  ...
  return (
    <section className="md:pt-[125px] pt-[90px] md:pl-11 md:pr-11 mb-0 md:max-w-[1034px] h-[fit] mx-auto md:mx-auto p-4">
        ...
        <div className="grid md:w-[900px] rounded-2xl grid-cols-1 gap-1 md:grid-cols-6 md:grid-rows-4 h-fit md:h-[610px]">
            ...
            <div className="col-span-1 flex items-center text-2xl text-[#2f85b8] p-4 rounded-2xl w-full md:h-[150px] md:col-start-2 md:row-start-1 bg-stone-100 ">
              <div className="flex-col">
            ...
            <div className="md:col-span-1 rounded-2xl w-full md:h-[150px] md:col-start-2 bg-[#2f85b8] flex p-4 items-center text-stone-100 text-2xl ">
              <div className="flex-col">
            ...
            <div className="relative flex flex-col justify-end w-full h-[108px] md:h-full p-4 overflow-hidden md:row-span-2 md:col-start-1 md:col-span-2 rounded-2xl isolate">
